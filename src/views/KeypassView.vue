...
const techStack = ref([
    ...
    },
    {
        ...
        color: '#512BD4',
        skills: [
            { name: 'Node.js', percent: 50, image: nodeIcon },
            { name: 'Express', percent: 50, image: expressIcon }
        ]
    },
    {
        categoryKey: 'Data base',
        icon: '🗄️',
        color: '#336791',
        skills: [
      ...
      <section class="project-section fade-in">
        ...
        <div class="content-card">
          ...
          <div class="security-highlight">
            ...
            <p v-html="$t('keypass_project_security')"></p>
          </div>
        </div>
      </section>
        ...
        <div class="tech-stack-grid">
          ...
          >
            <div class="category-header">
              ...
              <h3 class="category-title">{{ category.categoryKey }}</h3>
            </div>
