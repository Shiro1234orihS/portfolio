...
<template>
  <div class="skills-wrapper">
      ...
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="100">
            ...
            <img
              src="./../../public/picture/technical/CShapeIcone.png"
              alt="CShapeIcone"
            />
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="80">
            ...
            <img src="./../../public/picture/technical/javaIcone.png" alt="Java" />
            <div class="percentage-text">90%</div>
          </div>
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="70">
            ...
            <img
              src="./../../public/picture/technical/pythonIcone.png"
              alt="pythonIcone"
            />
    ...
    <div class="skills-container" data-category="web-frontend">
      <div class="category-header">
      ...
      <div class="skills-grid">
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="80">
            ...
            <img
              src="./../../public/picture/technical/javascriptIcone.png"
              alt="JavaScript"
            />
            <div class="percentage-text">0%</div>
          </div>
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="60">
            ...
            <img src="./../../public/picture/technical/typescript.png" alt="TypeScript" />
            <div class="percentage-text">0%</div>
          </div>
    ...
    <div class="skills-container" data-category="frontend">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("frontend_frameworks") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="90">
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="90">
            ...
            <img src="./../../public/picture/technical/vaadinIcone.png" alt="Vaadin" />
            <div class="percentage-text">0%</div>
          </div>
          <p class="skill-name">Vaadin</p>
        </div>
        <div class="skill">
          <div class="progress-circle" data-percent="80">
            <svg>
    ...
    <div class="skills-container" data-category="backend">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("backend_api") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="90">
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="90">
            ...
            <img
              src="./../../public/picture/technical/ExpressIcone.png"
              alt="Express.js"
            />
            <div class="percentage-text">0%</div>
          </div>
    ...
    <!-- ORM & Gestion de données -->
    <div class="skills-container" data-category="orm">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("orm_data_management") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="95">
            ...
            <img
              src="./../../public/picture/technical/EntityFrameworkCore.png"
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="95">
            ...
            <img src="./../../public/picture/technical/Sequelize.png" alt="Sequelize" />
            <div class="percentage-text">0%</div>
          </div>
    ...
    <div class="skills-container" data-category="database">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("databases") }}</h2>
      </div>

      <!-- RDBMS -->
      <div class="subcategory">
        <h3 class="subcategory-title">{{ $t("rdbms_admin") }}</h3>
        <div class="skills-grid">
          <div class="skill">
            <div class="progress-circle" data-percent="80">
              <svg>
              ...
              <img
                src="./../../public/picture/technical/SqlServeurIcone.png"
                alt="SQL Server"
              />
              <div class="percentage-text">0%</div>
            </div>
          ...
          <div class="skill">
            <div class="progress-circle" data-percent="80">
              ...
              <img
                src="./../../public/picture/technical/PostgresqlIcone.png"
                alt="PostgreSQL"
              />
              <div class="percentage-text">0%</div>
            </div>
        ...
        <div class="skills-grid">
          <div class="skill">
            <div class="progress-circle" data-percent="60">
              ...
              <img
                src="./../../public/picture/technical/mongodbIcones.svg"
                alt="MongoDB"
              />
              <div class="percentage-text">0%</div>
            </div>
          ...
          <div class="skill">
            <div class="progress-circle" data-percent="60">
              ...
              <img
                src="./../../public/picture/technical/InfluxdbIcone.png"
                alt="MongoDB"
              />
              <div class="percentage-text">0%</div>
            </div>
            <p class="skill-name">Influx DB</p>
          </div>
          <div class="skill">
            <div class="progress-circle" data-percent="60">
              <svg>
              ...
              <img
                src="./../../public/picture/technical/GrafanaIcone.png"
                alt="MongoDB"
              />
              <div class="percentage-text">0%</div>
            </div>
            <p class="skill-name">Grafana</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="skills-container" data-category="mobile">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("mobile_development") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="50">
            ...
            <img
              src="./../../public/picture/technical/reactIcone.svg.png"
              alt="React Native"
            />
            <div class="percentage-text">0%</div>
          </div>
    ...
    <div class="skills-container" data-category="libraries">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("libraries_testing") }}</h2>
      </div>

      <!-- Testing -->
      <div class="subcategory">
        <h3 class="subcategory-title">{{ $t("testing") }}</h3>
        <div class="skills-grid">
          <div class="skill">
            <div class="progress-circle" data-percent="70">
              <svg>
          ...
          <div class="skill">
            <div class="progress-circle" data-percent="70">
              ...
              <img
                src="./../../public/picture/technical/vitestIcone.png"
                alt="vitestIcone"
              />
              <div class="percentage-text">0%</div>
            </div>
            <p class="skill-name">Vite Test</p>
          </div>
        </div>
      </div>
      ...
      <!-- Graphiques -->
      <div class="subcategory">
        <h3 class="subcategory-title">{{ $t("graphics_3d") }}</h3>
        <div class="skills-grid">
          <div class="skill">
            <div class="progress-circle" data-percent="60">
              <svg>
    ...
    <div class="skills-container" data-category="tools">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("dev_tools") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="100">
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="50">
            ...
            <img
              src="./../../public/picture/technical/VisualStudioIcone.png"
              alt="Visual Studio"
            />
            <div class="percentage-text">0%</div>
          </div>
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="80">
            ...
            <img src="./../../public/picture/technical/dockerIcone.png" alt="Docker" />
            <div class="percentage-text">0%</div>
          </div>
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="80">
            ...
            <img
              src="./../../public/picture/technical/RaspberryOsIcone.png"
              alt="Docker"
            />
            <div class="percentage-text">0%</div>
          </div>
    ...
    <!-- Cloud & DevOps -->
    <div class="skills-container" data-category="cloud">
      <div class="category-header">
        <h2 class="degree-title">{{ $t("cloud_devops") }}</h2>
      </div>
      <div class="skills-grid">
        <div class="skill">
          <div class="progress-circle" data-percent="60">
        ...
        <div class="skill">
          <div class="progress-circle" data-percent="60">
            ...
            <img
              src="./../../public/picture/technical/Azure Dev Ops.webp"
              alt="Azure DevOps"
            />
            <div class="percentage-text">0%</div>
          </div>
...
.progress-circle {
  ...
  box-shadow: 0 10px 25px var(--box-shadow), inset 0 1px 0 rgba(255, 255, 255, 0.6);
...
.dark-mode .progress-circle:hover {
  box-shadow: 0 20px 40px rgba(0, 0, 0, 0.6), 0 0 20px var(--primary-color);
}
