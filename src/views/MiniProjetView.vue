...
const init3DScene = () => {
    ...
    loader.load(
        ...
        function (error) {
            ...
            if (loadingProgress) {
                loadingProgress.parentElement.innerHTML = '<p style="color: #ef4444;">Erreur de chargement du modèle 3D</p>';
            }
        }
    );
        ...
        <div class="hero-section" :class="{ 'loaded': isLoaded }">
            ...
            <div class="hero-content">
                ...
                <div class="categories-nav">
                    <button v-for="category in projectCategories" :key="category.id" @click="switchSection(category.id)"
                        class="category-btn" :class="{ 'active': currentSection === category.id }"
            ...
            <div class="hero-visual">
                <div class="techniques-showcase">
                    <div v-for="(technique, index) in techniques" :key="index" class="technique-pill"
        ...
        <div class="container">
                    ...
                    <div class="viewer-card">
                        <div class="viewer-header">
                            ...
                            <div class="viewer-controls">
                                <button @click="toggleAutoRotate" class="control-btn" title="Toggle Auto-rotate">
            ...
            <section id="section-css" class="project-section fade-in">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Animations SVG et CSS avancées pour logos sociaux</p>
                </div>
                        ...
                        <div id="containerLogo" class="logos-grid">
                            <div class="logo-section">
                                ...
                                <div class="logo-containerbas">
                                    <svg class="loader github-loader" xmlns="http://www.w3.org/2000/svg" width="120"
                            ...
                            <div class="logo-section">
                                ...
                                <div class="logo-containerbas">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="120" height="120"
                                        viewBox="0 0 2499.899999999999 2500" class="loader instagram-loader">
                    ...
                    <div class="animation-details">
                        ...
                        <div class="techniques-grid">
                            <div class="technique-card">
                                ...
                                <p>Utilisation de stroke-dasharray et stroke-dashoffset pour créer des effets de traçage
                                </p>
