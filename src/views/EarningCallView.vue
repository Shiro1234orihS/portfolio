...
// Données du projet financier
const projectMetrics = ref([
    { label: 'Entreprises analysées', value: '500+', icon: '🏢' },
    { label: 'Données traitées', value: '1M+', icon: '📊' },
    { label: 'Précision', value: '95%', icon: '🎯' },
    { label: 'Temps réel', value: '<1s', icon: '⚡' }
]);
...
const features = ref([
    { icon: '📊', title: 'Analyse en Temps Réel', description: 'Données financières actualisées instantanément' },
    { icon: '📈', title: 'Visualisations Avancées', description: 'Graphiques interactifs et tableaux de bord' },
    { icon: '🔍', title: 'Recherche Intelligente', description: 'Filtrage et recherche multi-critères' },
    { icon: '📱', title: 'Interface Responsive', description: 'Optimisée pour tous les appareils' }
]);
        ...
        <div class="hero-section" :class="{ 'loaded': isLoaded }">
            ...
            <div class="hero-content">
                <div class="project-badge">
                    ...
                    <span>Plateforme Financière</span>
                </div>

                <h1 class="hero-title" v-html="$t('earning_project_title')"></h1>

                <div class="hero-subtitle">
                    Analyse en temps réel des résultats financiers d'entreprises
                </div>

                <div class="metrics-grid">
                    <div v-for="(metric, index) in projectMetrics" :key="index" class="metric-card"
        ...
        <div class="container">
                ...
                <div class="content-card">
                    ...
                    <div class="card-content">
                        <div class="description-section">
                            <p class="project-description" v-html="$t('earning_project_description')"></p>
            ...
            <section class="technologies-section fade-in">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Stack technologique et APIs financières</p>
                </div>
                ...
                <div class="tech-showcase">
                    ...
                    <div class="tech-category">
                        <h3 class="category-title">APIs & Données</h3>
            ...
            <section class="skills-section fade-in">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Compétences techniques mises en œuvre</p>
                </div>

                <div class="skills-container">
                    <div v-for="(tech, index) in technologies" :key="index" class="skill-category"
                        ...
                        <div class="results-showcase">
                            ...
                            <div class="result-content">
                                ...
                                <div class="impact-metrics">
                                    ...
                                    <div class="impact-item">
                                        <div class="impact-icon">🎯</div>
                                        <span>Données précises en temps réel</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
.hero-section::before {
    ...
    height: 100%;
    background-image:
        radial-gradient(2px 2px at 40px 60px, rgba(16, 185, 129, 0.3), transparent),
