...
const techStack = ref([
  ...
  },
  {
    ...
    icon: "🗄️",
    color: "#336791",
    skills: [{ name: "PostgreSQL", percent: 85, image: PostgresqlIcone }],
  },
]);
      ...
      <div class="hero-visual">
        <div class="java-ecosystem">
          ...
          <div class="tech-orbit">
            <div class="tech-node vaadin" :style="{ '--angle': '0deg' }">
              <img :src="vaadinIcon" alt="Vaadin" class="tech-icon" />
            </div>
            <div class="tech-node spring" :style="{ '--angle': '120deg' }">
              <img :src="springBootIcon" alt="Spring Boot" class="tech-icon" />
            </div>
            <div class="tech-node postgres" :style="{ '--angle': '240deg' }">
        ...
        <div class="content-card highlight-card">
          ...
          <div class="card-content">
            <div class="github-section">
              ...
              <a
                href="https://github.com/AlixLejeune/SAE-6.02"
                target="_blank"
                class="github-button"
              >
