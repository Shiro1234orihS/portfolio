...
const projects = [
  {
    ...
    icon: "🎮",
    image: "/picture/westsofsurvival/icone_westsofsurvival.png",
    color: "#8B4513",
  },
  {
    to: "laravelbmw",
    title: "BMW Laravel",
    icon: "🚗",
    image: "/picture/BmwLaravel/incone_laravel.png",
    color: "#FF2D20",
  },
  {
    to: "vuebmx",
    title: "BMW Vue.js",
    icon: "⚡",
    image: "/picture/BmwVueJs/icone_vue.js.png",
    color: "#4FC08D",
  },
  {
    to: "vueprojex",
    ...
    icon: "🐳",
    image: "/picture/YProject/acceuil.webp",
    color: "#2496ED",
  },
  {
    to: "homeassistant",
    ...
    icon: "🐳",
    image: "/picture/homeAssistent/homeAssistantHome.png",
    color: "#2496ED",
  },
  {
    to: "homeassistant2",
    ...
    icon: "🐳",
    image: "/picture/homeAssistant2.0/homeAssistant2.0Home.png",
    color: "#2496ED",
  },
  // {
  //   to: "miniprojet",
  //   title: "Mini Projets",
  //   icon: "🔧",
  //   image: "/picture/MiniProjet/logo.png",
  //   color: "#6366F1",
  // },
  {
    to: "keypass",
    title: "KeyPass",
    icon: "🔐",
    image: "/picture/Keypass/image.png",
    color: "#059669",
  },
  {
    to: "earningcall",
    title: "Earning Call",
    icon: "📊",
    image: "/picture/earningCall/iconebull.png",
    color: "#DC2626",
  },
  {
    to: "intranetHome",
    title: "Intranet Home",
    icon: "📊",
    image: "/picture/Intranet/Acceuille/home.png",
    color: "#DC2626",
  },
  {
    to: "intranetKeypass",
    title: "Keypass Intranet",
    icon: "📊",
    image: "/picture/Intranet/Kespass/home.png",
    color: "#DC2626",
  },
  {
    to: "intranetAgenda",
    title: "NotePad Intranet",
    icon: "📊",
    image: "/picture/Intranet/Notepad/home.png",
    color: "#DC2626",
  },
  {
    to: "intranetNotepad",
    title: "NotePad Intranet",
    icon: "📊",
    image: "/picture/Intranet/Agenda/home.png",
    color: "#DC2626",
  },
];
