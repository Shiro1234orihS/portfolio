    ...
    <div class="project-menu" :class="{ 'expanded': isExpanded }">
        ...
        <div class="menu-dropdown" :class="{ 'visible': isExpanded }">
            ...
            <div class="projects-list">
                <router-link v-for="project in projects" :key="project.to" :to="project.to" class="project-item"
                    :class="{ 'active': $route.name === project.to }" :style="{ '--project-color': project.color }"
                    @click="closeMenu" @mouseenter="showTooltip = project.to" @mouseleave="showTooltip = ''">
            ...
            <div class="menu-footer">
                <div class="current-project" v-if="$route.name">
                    Projet actuel: <strong>{{projects.find(p => p.to === $route.name)?.title || 'Inconnu'}}</strong>
                </div>
            </div>
        </div>
...
:root {
    ...
    --menu-shadow-lg: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04);
}
...
.dark-mode {
    ...
    --menu-shadow-lg: 0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2);
}
...
.project-item.active {
    background: linear-gradient(135deg, var(--project-color), rgba(var(--project-color), 0.1));
    color: white;
